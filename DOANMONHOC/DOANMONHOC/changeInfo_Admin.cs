...
{
    public partial class changeInfo_Admin : Form
    {
        private Form indexForm;
        private bool isBackButtonPressed;

        public changeInfo_Admin(Form parentForm)
        {
            InitializeComponent();
        ...
        private async void guna2Button7_Click(object sender, EventArgs e)
        {
            if (Change_PW.Checked)
            {
                if (guna2TextBox2.Text != "" && guna2TextBox3.Text != "" && guna2TextBox4.Text != "")
                {
                    if (guna2TextBox3.Text == guna2TextBox4.Text && IsStrongPassword(guna2TextBox3.Text))
                    {
                        ...
                        foreach (var admin in admins)
                        {
                            if (admin.Value.UserName.ToString() == Properties.Settings.Default.Username.ToString() && VerifyPassword(guna2TextBox2.Text, admin.Value.Password))
                            {
            ...
            changeInfo_Admin_Load(sender, e);
        ...
        private void Clearn_Image_Click(object sender, EventArgs e)
        {
            avt = DefaultAvt;
            string base64String = avt;
